...
export type FaviconSize = number | {size: number, rename: string};
...
export type PresetTargets = string | string[] | Record<string, string>;
...
export type WatchableTasks = 'styles' | 'scripts' | 'images' | 'icons';
